...
if SELECT == "Explore Data":
    ...
    if fl is not None:
        ...
        # Provide the default file path if no file is uploaded
        default_file_path = r"D:\My files\Nagammai\Guvi\MDE86\code\Data.csv"
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"Nagammai SP"}')
    mail = (f'{"Mail :"}  {"swarna311294@gmailcom"}')
    Batch = (f'{"Batch Code :"}  {"MDE86"}')
    description = "!.....!"
    social_media = {

        "GITHUB": "https://github.com/NagammaiSP"
        }

    col1, col2 = st.columns(2)
    col1.image(Image.open(r"D:\My files\Nagammai\Guvi\MDE86\code\airbnblogo.jpg"), width=300)
